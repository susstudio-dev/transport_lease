...
export function CorporateServiceRequestsPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Raise tickets for servicing, breakdowns, accidents, or replacement vehicles."
        actions={
          <Button asChild>
            <Link to="/corporate/service-requests/new">
      ...
      <DataTable
        ...
        onRowClick={(row) => navigate(`/corporate/service-requests/${row.id}`)}
        emptyTitle="No service requests yet"
        emptyDescription="Raise your first ticket whenever you need servicing or report an issue."
        emptyAction={
